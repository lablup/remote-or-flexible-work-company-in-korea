...
| [래블업(Lablup)](#래블업) | O | O | [회사소개](https://www.lablup.com) |
...
### 래블업
- 재택/원격 근무 자유, 자율 출퇴근 (주 5일 40시간 기준)
  - 회사 설립부터 1년여 간 서울/대전/포항으로 나누어 원격근무 체제로 시작, 현재는 선릉역에 사무실 운영
  - 재택/원격 근무자가 다수인 경우 하루 1회 전체 화상회의 (10~30분)
  - 출근 시에는 13-16pm 사이에 사무실에 있는 것을 권장하나 의무는 아님
- 휴가 자율 사용
- 분기/연 단위 워크샵(retreat)
- 출근 시 점심 식대 / 원두 커피(전자동 에스프레소) / 음료·간식 지원
- 임직원 건강검진 지원
- 맥북프로 및 5K 모니터 환경 제공, 2년 근속 시 맥북프로 본인 소유로 지급
- 사내 호칭은 상호 존댓말과 "님"으로 통일
